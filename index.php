					...
					<div class="tab-pane fade show active" role="tabpanel" id="nav-missions" aria-labelledby="nav-missions-tab">
						<div class="col-md-12">
							<div class="row">						
								...
								<div class="col-md-6">
									<div class="product-image" style="background-image: url(./images/img-template/tabimg.jpg);background-size: cover;"></div>
								</div>
					...
					<div class="tab-pane fade" role="tabpanel" id="nav-values" aria-labelledby="nav-values-tab">
						<div class="col-md-12">
							<div class="row">
								...
								<div class="col-md-6">
									<div class="product-image" style="background-image: url(./images/img-template/tabimg1.jpg);background-size: cover;"></div>
								</div>
	...
	<div class="container">
		...
		<div class="d-flex products-slider">
				...
				<div class="product-item col-md-3 pl-0">
					<a href="./views/single-product.php" class="product-image"><img src="./images/img-template/cake-item1.jpg"></a>
					<div class="text-comtent text-center text-hover">
						<h5 class="pt-4"><a href="./views/single-product.php">Black Forest Pastry</a></h5>
						<p>Cake - Pastries</p>
						<span class="price colored">$12</span>
					</div>
				</div>
				<div class="product-item col-md-3 pl-0">
					<a href="./views/single-product.php" class="product-image"><img src="./images/img-template/cake-item2.jpg"></a>
					<div class="text-comtent text-center text-hover">
						<h5 class="pt-4"><a href="./views/single-product.php">Sprinkled Donuts</a></h5>
						<p>Cake - Pastries</p>
						<span class="price colored">$12</span>
					</div>
				</div>
				<div class="product-item col-md-3 pl-0">
					<a href="./views/single-product.php" class="product-image"><img src="./images/img-template/cake-item3.jpg"></a>
					<div class="text-comtent text-center text-hover">
						<h5 class="pt-4"><a href="./views/single-product.php">Black Forest Cupcake</a></h5>
						<p>Cake - Pastries</p>
						<span class="price colored">$12</span>
					</div>
				</div>
				<div class="product-item col-md-3 pl-0">
					<a href="./views/single-product.php" class="product-image"><img src="./images/img-template/cake-item4.jpg"></a>
				    <div class="text-comtent text-center text-hover">
						<h5 class="pt-4"><a href="./views/single-product.php">Macarons with Berries</a></h5>
						<p>Cake - Pastries</p>
						<span class="price colored">$12</span>
					</div>
				</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-6 left-post pl-0 mb-3">
				...
				<a href="./views/single-post.php"><img src="./images/img-template/postImg1.jpg" alt="cake" class="largeImg"></a>
		...
		<div class="row">
			<div class="col-md-12">
				<ul class="d-flex list-unstyled justify-content-between flex-wrap">
					<li><a href="#"><img src="./images/img-template/baker.svg" class="brandImg"></a></li>
					<li><a href="#"><img src="./images/img-template/bakery.svg" class="brandImg"></a></li>
					<li><a href="#"><img src="./images/img-template/thebakery.svg" class="brandImg"></a></li>
					<li><a href="#"><img src="./images/img-template/breadcookies.svg" class="brandImg"></a></li>
					<li><a href="#"><img src="./images/img-template/bakery.svg" class="brandImg"></a></li>
				</ul>
			</div>
		</div>
